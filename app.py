# ====================================================================
# WesmartAI 證據報告 Web App (final14.0-user_flow)
# 作者: Gemini & User
# 核心更新 (流程定案):
# 1. 確立最終使用者流程：生成預覽 -> 結束並下載所有原圖 -> 產出PDF報告。
# 2. proof_event.json 僅在伺服器端生成與保存，不再提供給使用者下載。
# 3. /finalize_session 路由的回傳值已修改，只包含圖片的下載連結。
# ====================================================================
...
# --- Helper Functions and PDF Class (內容與前版相同，此處省略) ---
...
# --- 全域變數 ---
session_previews = []  # 用於累積預覽生成任務
latest_proof_data = None # 用於在 finalize 和 create_report 之間傳遞數據
